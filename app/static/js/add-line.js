...
//                 attribute_span.classList.add("span-attribute")
//                 td_attribute = document.getElementsByClassName("td_attribute")[current_index];
//                 var exists = document.getElementById("attribute-span-for-" + count_tr)
//                 if (!exists) {
//                     $(attribute_span).appendTo($(td_attribute))
//                 }
//                 $(".inp_attribute:last").attr('hidden', true);

//                 var value = $(".inp_value:last").val()
//                 var value_span = document.createElement("span");
//                 value_span.innerHTML = value;
//                 value_span.id = "span-attribute-value-" + count_tr
//                 value_span.classList.add("span-attribute-value")
//                 td_value = document.getElementsByClassName("td_value")[current_index];
//                 var exists = document.getElementById("span-attribute-value-" + count_tr)
//                 if (!exists) {
//                     $(value_span).appendTo($(td_value))
//                 }
//                 $(".inp_value:last").attr("hidden", true)
//                 $(".form-icon-right:last").css("display", "none")
//             }
//             if ($("#attribute-span-for-" + count_tr).length && $("#span-attribute-value-" + count_tr).length) {
